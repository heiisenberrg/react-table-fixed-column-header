...
var ReactTable = function (_React$PureComponent) {
  _inherits(ReactTable, _React$PureComponent);
  ...
  _createClass(ReactTable, [{
    ...
    value: function loadData() {
      ...
      setTimeout(function () {
        _this2.setState({
          loading: false,
          rowData: _this2.props.data.slice(0, _this2.state.limit + _this2.props.rowsLimit),
          limit: _this2.state.limit + _this2.props.rowsLimit,
          isLimitReached: _this2.state.limit + _this2.props.rowsLimit > _this2.props.data.length ? true : false
        });
      }, 5000);
      return;
    }
    ...
    value: function componentDidMount() {
      ...
      document.querySelector(".scrollable-columns > .sc-body").addEventListener("scroll", function () {
        ...
        if (_this3.props.isVirtualScroll && parent.scrollHeight === parent.offsetHeight + parent.scrollTop && !_this3.state.isLimitReached && !_this3.state.loading) {
          _this3.loadData();
        }
      }, { passive: true });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'fc-body', style: { height: this.props.height ? this.props.height : 500 } },
        ...
        _react2.default.createElement(
          'div',
          { className: 'scrollable-columns', style: { marginLeft: fixedColWidth ? fixedColWidth + 32 : 182, width: scrollableColWidth ? scrollableColWidth : 800 } },
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'sc-body', style: { height: this.props.height ? this.props.height : 500 } },
            rowData && rowData.length > 0 && rowData.map(function (dataObj, index) {
              return _react2.default.createElement(
                'div',
...
ReactTable.propTypes = {
  ...
  isVirtualScroll: _propTypes2.default.bool,
  rowsLimit: _propTypes2.default.number,
  scrollableColWidth: _propTypes2.default.number,
  height: _propTypes2.default.number,
  fixedColWidth: _propTypes2.default.number,
